    ...
    MovimentoDAO movdao;
     ...
     public ResultSet movimentodiario(String data){
         ...
         try{
             ...
             stmt = con.prepareStatement("select DT.DATA, CF.CONTAGEM, US.USUARIO,MV.HORA, TTV.VENDAS_A_VISTA, TTV.VENDAS_MAIS_ENTR, TTV.SOMAMOVIMENTO, MV.ENTREGA,\n" +
"RP.CLIENTE_PAGANTE, RP.COMPETENCIA, MV.RECEBIMENTO_PRAZO, MV.CARTAO, MV.VENDA_AVISTA, MV.VALE, \n" +
